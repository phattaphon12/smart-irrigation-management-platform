...
export default function WaterBalanceChart({ waterBalance }) {
  ...
  return (
    <div className="cc" style={{ position: 'relative' }} onMouseLeave={() => setHover(null)}>
      <div className="node-legend" style={{ flexWrap: 'wrap', marginBottom: 10 }}>
        <div className="legend-item"><span style={{ width: 10, height: 10, borderRadius: 2, background: '#3b82f6', display: 'inline-block' }} />Rain − Water Use</div>
        <div className="legend-item"><span style={{ width: 10, height: 10, borderRadius: 2, background: '#10b981', display: 'inline-block' }} />Moisture Change</div>
        <div className="legend-item" style={{ color: '#ea580c', fontWeight: 700 }}><IconDiamond size={9} /> Irrigation Detected</div>
      </div>
